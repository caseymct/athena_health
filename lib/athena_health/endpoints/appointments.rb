module AthenaHealth
  module Endpoints
    module Appointments
      ...
      def create_appointment_slot(practice_id:, department_id:, appointment_date:, appointment_time:, provider_id:, reason_id:, params: {})
        @api.call(
          endpoint: "#{practice_id}/appointments/open",
          method: :post,
          body: params.merge(
      ...
      def booked_appointments(practice_id:, provider_id:, start_date:, end_date:, params: {})
        response = @api.call(
